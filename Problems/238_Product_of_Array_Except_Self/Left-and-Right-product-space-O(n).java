...
- used up by the two intermediate arrays that we constructed to keep track of product of elements to the left and right.
*/
...
class Solution {
    public int[] productExceptSelf(int[] nums) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            // For the last element, product except self would be L[i]
